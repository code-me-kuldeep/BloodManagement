...
export default function Required() {
  ...
  const validate = () => {
    const error = {};
    if (Fname === "") error.Fname = "Firstname is required";

    if (Lname === "") error.Lname = "Lastname is required";

    if (DOB === "") error.DOB = "DOB is required";

    if (Aadhar === "") error.Aadhar = "Aadhar is required";

    if (Bgroup === "") error.Bgroup = "Bloodgroup is required";

    if (phn === "") error.phn = "Phone no. is required";
      ...
      <div className="flex justify-center items-center h-full">
        <form
          onSubmit={handlesubmit}
            className="max-w-full h-full w-full p-4 "
        >
          <div className="flex justify-between py-6">
            <div>
              <h2 className="text-4xl font-bold text-left py-2">
                Blood-Required-form
              </h2>
          ...
          <div className="w-full flex items-center justify-center relative py-2">
            ...
            <p className="text-lg absolute text-black/90 bg-[#FFFFFF] px-2">
              {" "}
            </p>
          </div>
          ...
          <div className="flex justify-between py-3">
            <div className="flex flex-col mb-4">
              ...
              <input
                className="border relative rounded-md bg-[#FFFFFF] p-3"
                type="text"
                value={Fname}
                id="Fname"
                placeholder=" "
            ...
            <div className="flex flex-col mb-4">
              ...
              <select
                id="Rh factor "
                class="border relative rounded-md bg-[#FFFFFF] p-3"
              >
          ...
          <div className=" flex flex-col items-center">
            <button className="w-2/12 py-2 mt-5 bg-red-700 hover:bg-red-600  relative text-[#FFFFFF] rounded-md">
              Proceeed
            </button>
          </div>
        </form>
