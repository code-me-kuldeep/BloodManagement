...
const Hero = () => {
  return (
    <div className='w-full h-full bg-white flex flex-col justify-between' id="Hero">
        ...
        <div>
            ...
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                ...
                <h1 className='py-1 text-2xl md:text-2xl font-semibold text-[#F45050] animate-typing overflow-hidden whitespace-nowrap '>Saving Lives, One Click at a Time</h1>
