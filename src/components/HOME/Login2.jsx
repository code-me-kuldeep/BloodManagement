...
export default function Login() {
  ...
  return (
    ...
    <form onSubmit={handlesubmit} className=' relative mx-auto h-half bg-white p-4 rounded-3xl' >
            ...
            <h2 className='text-3xl font-bold text-left py-2'>Login</h2><p className='text-[#000000] text-40px'>please enter your login details to sign in</p></div>
            ...
            <div className='w-full flex items-center justify-between'>
                ...
                <button className='w-full py-2 mt-3 bg-[#F45050] hover:bg-blood hover:shadow-lg relative text-white  rounded-xl bg-midnight hover:shadow-blood border-0'>Log In</button>
            
            <p className='text-center py-2 mt-3 text-gray-400'>Don't have an account? <a href="/Register2">Sign up</a></p>
            
            
            <div className='w-full flex items-center justify-center relative py-2'>
               <div className='w-full h-[3px] bg-[#f45050]'></div>
               <p className='text-sm font-bold absolute text-black/90 bg-white px-2'> or continue with </p>
            ...
            <div className='flex justify-center py-3'>
               ...
               <button className='rounded-xl bg-white shadow-md hover:shadow-2xl hover:bg-current hover:shadow-blood '> <p className='border-1 rounded-xl hover:shadow-xl px-6 py-2 relative flex items-center text-ivory shadow-sm text-black'><FcGoogle className='mr-2' /> Google</p></button>
               <button className='rounded-xl bg hover:bg-current hover:shadow-blood bg-white hover:shadow-2xl'><p className='border-0 shadow-lg hover:shadow-xl px-6 py-2 relative flex items-center text-black  rounded-xl'><AiFillFacebook className='mr-2' /> <p className='text-black'>Facebook </p></p></button>
            </div>
        </form>
        </div>
    </div>
