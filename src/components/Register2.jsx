...
<form onSubmit={handlesubmit} className=' relative max-w-[400px] h-half w-full mx-auto bg-white p-4 rounded-3xl' >
            ...
            <div className='flex flex-col '> 
                ...
                <input onChange={(e)=>{setpassword(e.target.value)}} className='border relative bg-white p-2 rounded-md' type={(open === false)? 'password' :'text'}  placeholder='Password' value={password} id='password'/>
            ...
            <div className='w-full flex items-center justify-between'>
                ...
                <button className='w-full py-2 mt-3 bg-red-700 hover:bg-blood hover:shadow-lg relative text-white  rounded-xl bg-midnight hover:shadow-blood border-0'>Register</button>
